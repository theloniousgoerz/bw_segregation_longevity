...
censoc <- fread("./Data/Censoc/dataverse_files (2)/censoc_numident_v3.csv")
geog = fread("./Data/dataverse_files (2)/censoc_numident_geography_supplement_v1.csv")
census = fread("./Data/Census/usa_00006.csv",header = T)
...
rm(controls)
write.csv(controls_m,file = "./Data/_Cleaned/controls.csv")
