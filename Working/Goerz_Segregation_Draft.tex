...
There are two leading issues that may undermine exclusion. First, in its original usage \citep{ananat_wrong_2011}, the RDI is constructed for Northern metropolitan areas, because the majority of African Americans lived almost entirely in the South before the 1900s when the railroads were laid. Therefore only in non-Southern cities can railroad configuration be treated as exogenous to race and thought to induce segregation by Black inflows from the great migration. This the logic of exclusion rests on this restriction but limits the geographic generalizability of estimates. To overcome this, I adjust for residence in the South in all models and test the robustness of these results using an alternative set of instruments described in this section as well as sibling fixed effects estimates that do not require similar exclusion restrictions. 
...
What explains the the common effects of segregation on longevity for White and Black Americans?To test the importance of several political-economic mechanisms motivated by prior theoretical and empirical scholarship, I conduct a stepwise analysis of mechanisms compared to the baseline IV regressions (equation 4) \footnote{A descriptive table on the segregation mechanisms tested here are displayed in Appendix Table Axx.}. I start with estimates using the RDI stratified by race and include. 
...
\begin{enumerate}
  ...
  \item Table ---- Mechanism descriptive table 
  \item Table  ---- map 
\end{enumerate}

\subsection{B: Robustness}

\begin{itemize}
   \item Table --- IV by education, Whites
   \item Table --- IV by education, Blacks
   \item Table --- IV by gender 
   \item Table --- IV by birth cohort 
\end{itemize}
...
Thus far, the main estimates suggest overall that segregation harms Black and White individuals' longevity in substantial ways. How do these patterns vary by important social axes? In this section I consider variation by birth cohorts, education levels, and gender to probe the consistency of these results. 

Examining cohorts serve two purposes. The first is to probe how the results vary when considering individuals who were born in earlier versus later historical periods; the second is to provide a partial asessment of the selective impacts of military service on longevity. While no cohorts in my sample are completely excluded from military participation to facilitate a clean comparison between those who served and did not, birth cohort-stratified models offer the ability for a characterization of those who were more or less likely to have served. [Flesh out logic here]
